function mat_D_plus=assemble_D_plus(N_x,poly_order,reference_gradient)
	...
	for i_row = 1:N_x
		for k_row = 0:poly_order
			...
			for k_col = 0:poly_order
				...
				mat_D_plus(ind_row,ind_col) = -reference_gradient(k_row+1,k_col+1);
				% flux for the left edge
				ind_col = index_map_space(i_row,k_col,poly_order);
				mat_D_plus(ind_row,ind_col) = mat_D_plus(ind_row,ind_col)...
